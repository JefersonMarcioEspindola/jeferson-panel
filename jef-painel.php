...
function jef_painel_style() {
    wp_enqueue_style('jef-painel-style', plugins_url('jef-painel-style.css', __FILE__), array(), '1.0.2');
}
function jef_painel_style_login() {
    wp_enqueue_style('jef-painel-style-login', plugins_url('jef-painel-style-login.css', __FILE__), array(), '1.0.2');
}
...
function jef_painel_additional_admin_color_schemes() {
    wp_admin_css_color(
        'jef-painel',
        'Painel Jeferson',
        plugins_url( "jef-painel-colors.css", __FILE__) . '?ver=1.0.2'
    );
}
